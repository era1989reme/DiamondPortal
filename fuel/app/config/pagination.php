...
return array(
	...
	// Twitter bootstrap 3.x template
	'bootstrap3ajax'                   => array(
		'wrapper'                 => "<ul class=\"pagination\">\n\t{pagination}\n\t</ul>\n",

		'first'                   => "\n\t\t<li>{link}</li>",
		'first-marker'            => "<<",
		'first-link'              => "<a href=\"javascript:void(0)\" onclick=\"setPageFilter('{page}')\">{page}</a>",
		...
		'previous'                => "\n\t\t<li>{link}</li>",
		'previous-marker'         => "<",
		'previous-link'           => "<a href=\"javascript:void(0)\" rel=\"prev\" onclick=\"setPageFilter('{page}')\">{page}</a>",

		'previous-inactive'       => "\n\t\t<li class=\"disabled\">{link}</li>",
		'previous-inactive-link'  => "<a href=\"#\" rel=\"prev\" >{page}</a>",

		'regular'                 => "\n\t\t<li>{link}</li>",
		'regular-link'            => "<a href=\"javascript:void(0)\" onclick=\"setPageFilter({page})\">{page}</a>",
		...
		'next'                    => "\n\t\t<li>{link}</li>",
		'next-marker'             => ">",
		'next-link'               => "<a href=\"javascript:void(0)\" rel=\"next\" onclick=\"setPageFilter('{page}')\">{page}</a>",
		...
		'last'                    => "\n\t\t<li>{link}</li>",
		'last-marker'             => ">>",
		'last-link'               => "<a href=\"javascript:void(0)\" onclick=\"setPageFilter('{page}')\">{page}</a>",
