...
class Mandrill_Webhooks {
     ...
     *     - return[] struct the inidividual webhook info
     ...
     *     - last_error string if we've ever gotten an error trying to post to this webhook, the last error that we've seen
     */
    public function add($url, $events=array()) {
     ...
     *     - last_error string if we've ever gotten an error trying to post to this webhook, the last error that we've seen
     */
    public function update($id, $url, $events=array()) {
        $_params = array("id" => $id, "url" => $url, "events" => $events);
